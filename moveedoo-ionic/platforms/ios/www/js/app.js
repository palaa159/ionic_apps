var myApp = angular.module('myApp', ['ionic', 'ngCordova', 'ionic.contrib.frostedGlass']); // defining angular world
// Cache $http
    ...
    function($rootScope, $scope, $timeout, fetchData, Data, Helper, $ionicLoading, $cordovaGeolocation, $http) {        $scope.films = Data.data.films;
        ...
        if (!$rootScope.tracked) {
            $scope.loadingIndicator = $ionicLoading.show({
                content: '<img src="img/loader/ajax.gif"><br><b>Fetching Data</b>',
                animation: 'fade-in',
                showBackdrop: true,
                maxWidth: 200,
                showDelay: 0
